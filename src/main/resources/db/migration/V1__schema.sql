...
CREATE DATABASE IF NOT EXISTS `tutorlab` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `tutorlab`;
...
CREATE TABLE IF NOT EXISTS `tutee` (
    `tutee_id` bigint(20) NOT NULL AUTO_INCREMENT,
    `created_at` datetime DEFAULT NULL,
    `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tutor` (
    `tutor_id` bigint(20) NOT NULL AUTO_INCREMENT,
    `created_at` datetime DEFAULT NULL,
    `updated_at` datetime DEFAULT NULL,
    `user_id` bigint(20) NOT NULL,
