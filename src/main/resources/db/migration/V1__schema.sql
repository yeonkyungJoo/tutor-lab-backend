...
-- 테이블 tutorlab.cancellation 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `chatroom` (
  ...
  KEY `FK_CHATROOM_TUTEE_ID` (`tutee_id`),
  KEY `FK_CHATROOM_TUTOR_ID` (`tutor_id`),
...
-- 테이블 tutorlab.education 구조 내보내기
...
-- 테이블 tutorlab.enrollment 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `enrollment` (
  ...
  KEY `FK_ENROLLMENT_TUTEE_ID` (`tutee_id`),
...
-- 테이블 tutorlab.lecture_price 구조 내보내기
...
-- 테이블 tutorlab.lecture_subject 구조 내보내기
...
-- 테이블 tutorlab.lecture_system_type 구조 내보내기
...
-- 테이블 tutorlab.notification 구조 내보내기
...
-- 테이블 tutorlab.tutee 구조 내보내기
DROP TABLE IF EXISTS `tutee`;
CREATE TABLE IF NOT EXISTS `tutee` (
  `tutee_id` bigint NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
-- 테이블 tutorlab.tutorlab_file 구조 내보내기
DROP TABLE IF EXISTS `tutorlab_file`;
CREATE TABLE IF NOT EXISTS `tutorlab_file` (
